...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  await conn.reply(m.chat, `┌✦ *⚕️K H A L E D S H A T A H ⚕️*
┊• *👤اسم الادمن:* ${ryhar.registered ? ryhar.name : conn.getName(m.sender)}
${premTime > 0 ? `${clockString(ryhar.premiumTime - new Date() * 1)}` : '┊• *ستو💙ــرـــ💙ـيـات🙈💙:* Expired 🚫'}
╚┈┈┈┈┈┈┈┈┈✧
...
handler.tags = ['info']
handler.command = /^(owner|listprem|premlist)$/i
